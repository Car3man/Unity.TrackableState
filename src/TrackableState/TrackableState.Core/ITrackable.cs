...
namespace Klopoff.TrackableState.Core
{
    ...
    public sealed class ChangeEventArgs : EventArgs
    {
        ...
        public static ChangeEventArgs SetRemove(string setName, object oldItem)
            => new(PathSegmentType.Set, ChangeKind.CollectionRemove, setName, oldItem);
        ...
        private string BuildPathSlow()
        {
            ...
            return Inner.SegmentType is PathSegmentType.List or PathSegmentType.Set or PathSegmentType.Dictionary 
                ? $"{thisSeg}{innerPath}" 
                : $"{thisSeg}.{innerPath}";
        }
